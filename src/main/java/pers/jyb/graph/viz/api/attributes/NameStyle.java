...
class NameStyle implements NodeStyle, LineStyle, ClusterStyle, Serializable {
  ...
  static final NameStyle TAPERED = new NameStyle("tapered");
  static final NameStyle FILLED = new NameStyle("filled");
  static final NameStyle STRIPED = new NameStyle("striped");
  static final NameStyle WEDGED = new NameStyle("wedged");
  static final NameStyle DIAGONALS = new NameStyle("diagonals");
  static final NameStyle ROUNDED = new NameStyle("rounded");
  static final NameStyle RADIAL = new NameStyle("radial");
