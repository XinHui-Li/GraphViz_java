...
public class ClusterLabelEditor extends SvgEditor<ClusterDrawProp, SvgBrush> implements
    ClusterEditor<SvgBrush> {
  ...
  public boolean edit(ClusterDrawProp cluster, SvgBrush brush) {
    ...
    text(new TextAttribute(cluster.getLabelCenter(), fontSize, label,
                           clusterAttrs.getFontColor(), lineConsumer));
