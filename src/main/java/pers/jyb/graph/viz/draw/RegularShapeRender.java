...
public class RegularShapeRender extends CustomizeShapeRender {
  ...
  public void drawSvg(SvgBrush nodeBrush, NodeDrawProp nodeDrawProp) {
    ...
    Element shapeElement = SvgEditors
        .getShapeElement(nodeDrawProp, nodeBrush, SvgConstants.POLYGON_ELE);
    String pointsStr = SvgEditors.generatePolylinePoints(points);
